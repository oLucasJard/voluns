        ...
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Gere e baixe relatórios personalizados em diferentes formatos para análise externa.
            </p>
          </div>
        </div>

        <Suspense fallback={<div className="flex items-center justify-center h-64">Carregando opções de exportação...</div>}>
          <ExportReports />
        </Suspense>
      </div>
    </DashboardLayout>
