...
import { VolunteerDetails } from '@/components/dashboard/volunteers/VolunteerDetails'
      ...
      <div className="space-y-6">
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mt-4 flex md:mt-0 md:ml-4">
            <a
              href={`/dashboard/volunteers/${params.id}/edit`}
        ...
        <Suspense fallback={<div className="flex items-center justify-center h-64">Carregando voluntário...</div>}>
          <VolunteerDetails volunteerId={params.id} />
        </Suspense>
      </div>
    </DashboardLayout>
  )
